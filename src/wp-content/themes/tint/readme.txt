...
WordPress version: required at least 5.0, tested up to 6.7
...
Please install and activate it before starting to use the theme Tint.
...
Theme documentation is available on https://doc.themerex.net/tint/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Tint is Fontello.

...
if ( ! function_exists( 'tint_woocommerce_get_css' ) ) {
	add_filter( 'tint_filter_get_css', 'tint_woocommerce_get_css', 10, 2 );
	function tint_woocommerce_get_css( $css, $args ) {
...
$fdir = tint_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}

...
tint_storage_set('extended_products_tpl', 'plain');
...
add_action('woocommerce_after_shop_loop_item', 'tint_go_start_wrap_hover', 8);
add_action('woocommerce_after_shop_loop_item', 'tint_go_end_wrap_hover', 18);

if ( function_exists( 'tint_woocommerce_extensions_frontend_scripts' ) ) {
	remove_action( 'woocommerce_after_shop_loop_item', 'tint_woocommerce_extensions_show_attributes', 18 );
	add_action( 'woocommerce_after_shop_loop_item', 'tint_woocommerce_extensions_show_attributes', 9 );
}
...
if ( ! function_exists( 'tint_go_start_wrap_hover' ) ) {
	function tint_go_start_wrap_hover() {
		tint_show_layout('<div class="wrap-data-hover">');
	}
}
if ( ! function_exists( 'tint_go_end_wrap_hover' ) ) {
	function tint_go_end_wrap_hover() {
		tint_show_layout('</div>');
	}
}
...
<?php
	...
	remove_action('woocommerce_after_shop_loop_item', 'tint_go_start_wrap_hover', 8);
	remove_action('woocommerce_after_shop_loop_item', 'tint_go_end_wrap_hover', 18);

	if ( function_exists( 'tint_woocommerce_extensions_frontend_scripts' ) ) {
		add_action( 'woocommerce_after_shop_loop_item', 'tint_woocommerce_extensions_show_attributes', 18 );
		remove_action( 'woocommerce_after_shop_loop_item', 'tint_woocommerce_extensions_show_attributes', 9 );
	}
